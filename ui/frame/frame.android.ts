...
export class Frame extends frameCommon.Frame {
    ...
    public _navigateCore(backstackEntry: definition.BackstackEntry) {
        ...
        // Current Fragment
        var currentFragment: com.tns.FragmentClass;
        if (this._currentEntry) {
            this._currentEntry.isNavigation = true;
            currentFragment = <com.tns.FragmentClass>manager.findFragmentByTag(this._currentEntry.fragmentTag);
        }
        ...
        if (emptyNativeBackStack) {
            for (let i = 0; i < length; i++) {
                let fragmentToRemove = <com.tns.FragmentClass>manager.findFragmentByTag(manager.getBackStackEntryAt(i).getName());
    ...
    private static _clearHistory(fragment: com.tns.FragmentClass) {
        if (trace.enabled) {
...
lazyExtend("com.tns.FragmentClass",
...
lazyExtend("com.tns.NativeScriptActivity",
